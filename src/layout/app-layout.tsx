...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['team-member', 'business-owner', 'data-analyst'];
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'Apis', path: '/apis', entity: 'api', service: AccessServiceEnum.PROJECT, icon: FiCloud },
    ...
    { name: 'Securities', path: '/securities', entity: 'security', service: AccessServiceEnum.PROJECT, icon: FiShield },
