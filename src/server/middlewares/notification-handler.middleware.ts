...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'property.update': {
    ...
    key: 'property-data-update',
    tenantPath: ['organization', 'property'],
    userPath: [],
  },
  'dataset.create': {
    roles: ['data-analyst', 'team-member'],
    key: 'new-dataset-integration',
    tenantPath: ['organization', 'user', 'dataset'],
    userPath: [],
  },
  'security.update': {
    roles: ['data-analyst', 'team-member'],
    key: 'security-measure-update',
    tenantPath: ['organization', 'user', 'security'],
    userPath: [],
  },
};
...
const tenantRoles: string[] = ['business-owner', 'team-member', 'data-analyst'];
